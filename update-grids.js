...
const CONFIG = {
    fields: {
        ...
        // Regex: busca export const NOMBRE_FIELDS (con o sin _DEF), opcionalmente un tipo previo (: any[]), un igual y opcionalmente espacios/saltos de linea antes del [
    ...
    behavior: {
        ...
        // Regex: busca export const NOMBRE_BEHAVIOR (con o sin _DEF), opcionalmente un tipo previo, un igual y opcionalmente espacios/saltos de linea antes del [
